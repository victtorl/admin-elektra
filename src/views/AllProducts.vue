<template>
    <div class="   ">
        ...
        <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3  md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-10">
    ...
    <template #body>
      <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
        ¿Esta seguro que dese eliminar este producto? con id {{ itemdelete.id }}
      </p>
    </template>
    <template #footer>
